...
import { driverSchemas } from '../validators';
...
router.post('/location', authenticate, requireRole('driver'), validate(driverSchemas.location), controller.updateLocation.bind(controller));
